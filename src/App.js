...
export default function App() {
  ...
  //  this needs to be a pure function and also it can not be passed any arguments
  // react would call the function on the intial render (As the app component mounts and watched array would be set to localstorage values)
...
function Search({ query, setQuery }) {
  //  using ref with the Dom element has three steps
  // 1 we create ref
  //  initial value of current property of ref box(object is null in the case of selecting and manipulation of DOM)
  const inputEl = useRef(null);

  // second step , come to the element we want to select and pass the ref property
  // like this     ref={inputEl}
  ...
  // third step (in order to use the useRef we should not write it in render logic , so we use , useEffect)
  // useEffect(
  //   function () {
  //     // this is the Dom element itsself
  //     // console.log(inputEl.current)
  //     function callBack(e) {
  //       if (e.code === "Enter") {
  //         //  it would give which element in dom is currently active , if we are focused
  //         // already in the search bar , do nth and dont delete the text
  //         if (document.activeElement === inputEl.current) return;
  //         inputEl.current.focus();
  //         // for deleting not completed text if we are not focused on the search bar
  //         setQuery("");
  //       }
  //     }
  ...
  //   //  to focus on the search bar each time that this component renders or mounts
  //   //  typical Dom Manipulations
  //   el.focus();
  // }, []);
...
function MovieDetailes({ selectedId, onCloseMovie, onAddWatched, watched }) {
  ...
  // making a REF to count how many times a user decided for a rating , once for example 4 , 3,5
